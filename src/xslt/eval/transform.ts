...
import { getRecordedTracePause, resetRecordedTracePause } from '../../runtime/tracePause.js';
...
import { renderNumberInstruction } from './numbering.js';
import { buildTemporaryTree } from './temporaryTree.js';
import {
  emitInstructionSelectEvents,
  emitTraceEvent,
  emitValueReadEvents,
  tryCreateTraceNodeHandle,
} from './transformTrace.js';
