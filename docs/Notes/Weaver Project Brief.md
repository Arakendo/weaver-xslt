...
> Sources: `docs/Specifications/Weaver Software Design Document.md`, `docs/Plans/Compile Performance.md`, `docs/Plans/Fallback File Size.md`, `docs/Notes/Lessons Learned.md`, `docs/Plans/Weaver Roadmap.md`.
...
| -------------------- | --------------------------------------------------------------------------- |
| `docs/Specifications/Weaver Software Design Document.md`    | Understanding the four-layer pipeline, pinned decisions, and milestone plan |
| `docs/Specifications/Weaver Product Thesis.md` | What this project aims to be best at                                        |
| `docs/Plans/Weaver Roadmap.md`         | Full MVP/MVP+N execution plan with scope and exit criteria                  |
...
| -------------------------------- | --------------------------------------------------------------- |
| `docs/Plans/Compile Performance.md` | 31 min → 850 ms compile investigation, phase-by-phase profiling |
| `docs/Plans/Fallback File Size.md`       | 111 MB → 6.49 MB module reduction, byte attribution analysis    |
| `docs/Notes/Lessons Learned.md`             | Durable debugging memory from engine, CLI, and corpus work      |

### Diagnostics & Errors

| Document                   | What It Covers                                                    |
| -------------------------- | ----------------------------------------------------------------- |
| `docs/Specifications/Weaver Error Design Document.md`                | W3C error codes, `XdmError` hierarchy, diagnostic report contract |
| `docs/Specifications/Weaver Diagnostic Intrinsics Specification.md` | Compiler-recognized `wx:*` observability and assertion surface    |
...
| `docs/Plans/Workbench Embed.md` | Public host-facing embed API              |
| `docs/Specifications/Weaver Workbench API Specification.md`   | Engine-facing workbench boundary contract |
