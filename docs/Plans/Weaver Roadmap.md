...
> Status: active execution plan. This document is non-normative.
>
> Execution plan, not a spec. See [Weaver Software Design Document](../Specifications/Weaver%20Software%20Design%20Document.md) for
> pinned design decisions and [Weaver Product Thesis](../Specifications/Weaver%20Product%20Thesis.md)
> for the product thesis. See [Weaver XPath Design Document](../Specifications/Weaver%20XPath%20Design%20Document.md) for the XPath-specific
...
- [x] docs/Specifications/Weaver Software Design Document.md + docs/Specifications/Weaver Product Thesis.md with pinned DEC-001..015
...
- Hand-written lexer (`src/xpath/lex/lexer.ts`) with **every token carrying
  a full `SourceSpan`** compatible with `docs/Specifications/Weaver Error Design Document.md` (`uri`, UTF-16
...
- The QT3 gate now reports structured exclusion reasons, keeps `fn:*` matching case-sensitive to mirror the runtime surface, and exposes optional exclusion snapshots through `QT3_EXCLUSION_DEBUG=1`; see `docs/Corpus/QT3 Gate.md`.
...
- The priority mini-spec is captured in `docs/Specifications/Weaver Template Priority Specification.md` and names the executable fixtures that anchor the current dispatch behavior.
...
- [x] Chrome DevTools shows the `.xsl` in the source tree and stops on
      breakpoints (follow [Chrome DevTools Verification](../Evidence/Chrome%20DevTools%20Verification.md);
      manual verification published via [Progress Artifacts](../Evidence/Progress%20Artifacts.md))
...
Working checklist: [Native Execution Implementation Record](../Evidence/Native%20Execution%20Implementation%20Record.md)

Unsupported-native note: [Weaver Native Execution Boundary Specification](../Specifications/Weaver%20Native%20Execution%20Boundary%20Specification.md)
...
Working checklist: [JS Renderer Artifacts](JS%20Renderer%20Artifacts.md)
...
- Public milestone proof now exists both as the live page and as linked
  supporting media under [Progress Artifacts](../Evidence/Progress%20Artifacts.md).

Design note: [Weaver Workbench API Specification](../Specifications/Weaver%20Workbench%20API%20Specification.md) defines the Weaver-side
...
Design note: [XML Node Debugging](XML%20Node%20Debugging.md) defines the
...
Design notes: [WeaverPDF Plan](WeaverPDF.md),
[WeaverPDF v1 Specification](../Specifications/WeaverPDF%20v1%20Specification.md), and
[WeaverPDF Architecture Specification](../Specifications/WeaverPDF%20Architecture%20Specification.md) define the naming,
...
Design note: [Practical Streaming](Practical%20Streaming.md) tracks the current direction.
...
5. Did any semantic boundary weaken? Check against
   [Weaver Semantic Boundary Specification](../Specifications/Weaver%20Semantic%20Boundary%20Specification.md): lexical vs
