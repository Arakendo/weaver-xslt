...
- [Weaver Software Design Document](../Specifications/Weaver%20Software%20Design%20Document.md) for the public API and emission boundary
- [Weaver Roadmap](Weaver%20Roadmap.md) for increment placement
- [Fallback File Size](Fallback%20File%20Size.md) for serialized-IR size behavior that affects bundle size
- [Weaver Native Execution Boundary Specification](../Specifications/Weaver%20Native%20Execution%20Boundary%20Specification.md) for what "supported under native" means
- [Weaver Security Boundary Specification](../Specifications/Weaver%20Security%20Boundary%20Specification.md) for host-owned execution policy
...
- No ambient `eval`, network, or filesystem access added to the engine; the host
  owns execution sandboxing (see [Weaver Security Boundary Specification](../Specifications/Weaver%20Security%20Boundary%20Specification.md)).
...
[Fallback File Size](Fallback%20File%20Size.md)). Bundles should therefore
...
host responsibility, consistent with [Weaver Workbench API Specification](../Specifications/Weaver%20Workbench%20API%20Specification.md).
...
| `docs/Plans/Weaver Roadmap.md`                               | add the increment entry (see below)                                                                                                    |
| `docs/Specifications/Weaver Software Design Document.md`                          | note JS emission as an additional emit target on the existing boundary                                                                 |
...
to emitted TS/JS artifacts" ([Weaver Roadmap](Weaver%20Roadmap.md)). JS emission makes the
