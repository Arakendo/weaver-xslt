...
- [Weaver Software Design Document](../Specifications/Weaver%20Software%20Design%20Document.md) for the emission boundary (`ts` / `js` / `bundle`)
- [JS Renderer Artifacts](JS%20Renderer%20Artifacts.md) for the emitted-renderer contract
...
- [Weaver URI Resolution Specification](../Specifications/Weaver%20URI%20Resolution%20Specification.md) for resolver authority
- [Weaver Error Design Document](../Specifications/Weaver%20Error%20Design%20Document.md) for the structured diagnostic contract
...
- `compile --emit bundle` produces a self-contained **Node ESM** renderer
  ...
  ([JS Renderer Artifacts](JS%20Renderer%20Artifacts.md)).
...
The ASP.NET host must follow [Weaver Security Boundary Specification](../Specifications/Weaver%20Security%20Boundary%20Specification.md):
...
- mode B (runtime worker) must route resource access through a host-owned
  resolver bridge, consistent with [Weaver URI Resolution Specification](../Specifications/Weaver%20URI%20Resolution%20Specification.md) and
...
- A runtime/IR version should be embedded alongside the digest so a host can
  ...
  question 2 in [JS Renderer Artifacts](JS%20Renderer%20Artifacts.md); the NuGet
