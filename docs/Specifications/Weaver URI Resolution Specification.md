...
It complements [Weaver Software Design Document](Weaver%20Software%20Design%20Document.md), especially the core
"no Node-specific APIs in the engine" rule, [Weaver XPath Design Document](Weaver%20XPath%20Design%20Document.md) for
XPath static-context `baseUri`, and [Weaver Error Design Document](Weaver%20Error%20Design%20Document.md) for how
resolution failures surface diagnostically, plus
[Weaver Semantic Boundary Specification](Weaver%20Semantic%20Boundary%20Specification.md) for the broader rule
that lexical references, resolved identity, and host-policy boundaries
must not be collapsed into one vague helper, and
[Weaver Security Boundary Specification](Weaver%20Security%20Boundary%20Specification.md) for the higher-level rule
...
This is where [Weaver Error Design Document](Weaver%20Error%20Design%20Document.md) matters: URI failures are part of
