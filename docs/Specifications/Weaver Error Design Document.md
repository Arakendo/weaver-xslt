# Weaver Error Design Document

> Status: normative diagnostic contract, pre-stability.
...
It complements [Weaver Software Design Document](Weaver%20Software%20Design%20Document.md), especially DEC-007 and DEC-013,
and [Weaver Product Thesis](Weaver%20Product%20Thesis.md), especially D1. Those documents define
why diagnostics matter; this file defines the durable shape of the error and diagnostic
contract. See also [Weaver Semantic Boundary Specification](Weaver%20Semantic%20Boundary%20Specification.md) for the
