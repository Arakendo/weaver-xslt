...
It complements [Weaver Software Design Document](Weaver%20Software%20Design%20Document.md),
[Weaver Semantic Boundary Specification](Weaver%20Semantic%20Boundary%20Specification.md),
[Weaver URI Resolution Specification](Weaver%20URI%20Resolution%20Specification.md),
[Weaver Entity Resolution Specification](Weaver%20Entity%20Resolution%20Specification.md), and [Weaver Error Design Document](Weaver%20Error%20Design%20Document.md).
...
The detailed policy lives in [Weaver Entity Resolution Specification](Weaver%20Entity%20Resolution%20Specification.md).
...
The detailed resolver contract lives in [Weaver URI Resolution Specification](Weaver%20URI%20Resolution%20Specification.md).
...
- [Weaver Entity Resolution Specification](Weaver%20Entity%20Resolution%20Specification.md) defines parse-boundary entity
  policy under this broader security rule.
- [Weaver URI Resolution Specification](Weaver%20URI%20Resolution%20Specification.md) defines resolution and resource
  loading without granting ambient I/O.
- [Weaver Semantic Boundary Specification](Weaver%20Semantic%20Boundary%20Specification.md) defines the broader rule
