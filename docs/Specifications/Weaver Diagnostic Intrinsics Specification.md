...
[Weaver Product Thesis](Weaver%20Product%20Thesis.md), [Weaver XPath Design Document](Weaver%20XPath%20Design%20Document.md),
[Weaver Error Design Document](Weaver%20Error%20Design%20Document.md), and [Weaver Semantic Boundary Specification](Weaver%20Semantic%20Boundary%20Specification.md).
...
[Weaver Software Design Document](Weaver%20Software%20Design%20Document.md). Those are integration features. This
...
[Weaver Error Design Document](Weaver%20Error%20Design%20Document.md), not invent text-only side channels.
