...
This document is pinned design intent. [Weaver Software Design Document](Weaver%20Software%20Design%20Document.md)
...
- **Full XSLT 3.0 conformance, day one.** We will follow the
  milestones in `docs/Specifications/Weaver Software Design Document.md`. We will publish our conformance
...
2. **Source-located, exhaustively.** Every node has a full `SourceSpan`
  compatible with `docs/Specifications/Weaver Error Design Document.md`. Lose this at your peril.
...
This supersedes the milestones in `docs/Specifications/Weaver Software Design Document.md` for *ordering*,
...
in docs/Specifications/Weaver Software Design Document.md. The mantra is **"IR → string, or fix the IR."**
