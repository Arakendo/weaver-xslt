# Weaver Software Design Document

> Status: normative design, pre-stability. Accepted decision summaries live in
> `docs/ADR/`; the detailed DEC sections remain here as specification context.
> Change pinned decisions through an ADR, not by implementation drift.
>
> See [Weaver Product Thesis](Weaver%20Product%20Thesis.md) for the _why_. This file is
> the _how_. See [Weaver Semantic Boundary Specification](Weaver%20Semantic%20Boundary%20Specification.md) for
> cross-cutting rules about where meaning boundaries must stay explicit.
> See [NuGet Integration](../Plans/NuGet%20Integration.md) for the current .NET/NuGet
...
[Weaver XPath Design Document](Weaver%20XPath%20Design%20Document.md).
...
2. **Source-located exhaustively.** Every node carries
   a full source span compatible with [Weaver Error Design Document](Weaver%20Error%20Design%20Document.md)
...
[Weaver Error Design Document](Weaver%20Error%20Design%20Document.md). `XdmError` is the engine-facing throwable type;
...
See DEC-013, [Weaver Product Thesis](Weaver%20Product%20Thesis.md) D1, and
[Weaver Diagnostic Intrinsics Specification](Weaver%20Diagnostic%20Intrinsics%20Specification.md) for the narrow
...
Use [Weaver Diagnostic Intrinsics Specification](Weaver%20Diagnostic%20Intrinsics%20Specification.md) when the work
...
loading is defined in [Weaver URI Resolution Specification](Weaver%20URI%20Resolution%20Specification.md). `baseUri`
...
See [Weaver Workbench API Specification](Weaver%20Workbench%20API%20Specification.md) for the narrower engine-facing
