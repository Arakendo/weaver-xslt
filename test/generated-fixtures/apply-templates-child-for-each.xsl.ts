...
export function transform(sourceXml: string, ctx: TransformContext = {}): TransformResult {
  ...
  (() => {
  const body = escapeText(traceStringValueOfNode(currentNode, ctx, {"kind":"xsl:value-of","location":{"source":"apply-templates-child-for-each.xsl","line":1,"column":140,"offset":139,"endLine":1,"endColumn":150,"endOffset":149}}));
