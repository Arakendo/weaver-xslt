...
describe('XSLT codegen MVP4 slice', () => {
  ...
  it('executes a relative-select apply-templates for-each nested xsl:apply-templates stylesheet through the runtime surface', () => {
  ...
  it('executes a relative-select apply-templates for-each nested xsl:apply-templates stylesheet without select through the runtime surface', () => {
    const sourceXml = '<root><item><name>apple</name><group><detail>fresh</detail><detail>green</detail></group></item></root>';
  ...
  it('executes a multi-step relative-select simple-match for-each nested xsl:apply-templates stylesheet through the runtime surface', () => {
  ...
  it('executes a multi-step relative-select simple-match for-each nested xsl:apply-templates stylesheet without select through the runtime surface', () => {
    const sourceXml = '<root><section><item><name>apple</name><group><detail>fresh</detail><detail>green</detail></group></item></section></root>';
  ...
  it('executes a multi-step relative-select nested-match for-each nested xsl:apply-templates stylesheet through the runtime surface', () => {
    const sourceXml = '<root><section><item><name>apple</name><group><detail>fresh</detail><detail>green</detail></group></item></section></root>';
  ...
  it('executes a multi-step relative-select nested-match for-each nested xsl:apply-templates stylesheet without select through the runtime surface', () => {
    const sourceXml = '<root><section><item><name>apple</name><group><detail>fresh</detail><detail>green</detail></group></item></section></root>';
  ...
  it('executes a relative-select absolute-match for-each nested xsl:apply-templates stylesheet through the runtime surface', () => {
    const sourceXml = '<root><item><name>apple</name><group><detail>fresh</detail><detail>green</detail></group></item></root>';
  ...
  it('executes a relative-select absolute-match for-each nested xsl:apply-templates stylesheet without select through the runtime surface', () => {
    const sourceXml = '<root><item><name>apple</name><group><detail>fresh</detail><detail>green</detail></group></item></root>';
  ...
  it('executes an absolute match for-each nested xsl:apply-templates stylesheet through the runtime surface', () => {
    const sourceXml = '<root><item><name>apple</name><group><detail>fresh</detail><detail>green</detail></group></item></root>';
  ...
  it('executes an absolute match for-each nested xsl:apply-templates stylesheet without select through the runtime surface', () => {
    const sourceXml = '<root><item><name>apple</name><group><detail>fresh</detail><detail>green</detail></group></item></root>';
  ...
  it('executes an absolute nested match for-each nested xsl:apply-templates stylesheet through the runtime surface', () => {
    const sourceXml = '<root><section><item><name>apple</name><group><detail>fresh</detail><detail>green</detail></group></item></section></root>';
  ...
  it('executes an absolute nested match for-each nested xsl:apply-templates stylesheet without select through the runtime surface', () => {
    const sourceXml = '<root><section><item><name>apple</name><group><detail>fresh</detail><detail>green</detail></group></item></section></root>';
